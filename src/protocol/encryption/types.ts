...
export function isEncryptedStoredMessage(
  msg: AnyStoredMessage,
): msg is EncryptedStoredMessage {
  return (msg as EncryptedStoredMessage).__encrypted === true;
}

export function isEncryptedMessageAttachment(
  att: MessageAttachment | EncryptedMessageAttachment,
): att is EncryptedMessageAttachment {
  return (att as EncryptedMessageAttachment).__encrypted === true;
}

export function isEncryptedAttachmentMetadata(
  att: AttachmentMetadata,
): att is EncryptedAttachmentMetadata {
  return (att as EncryptedAttachmentMetadata).__encrypted === true;
}
