...
import type { EncryptedData, EncryptedStoredMessage, EncryptedAttachmentMetadata, EncryptionContext } from "./types.js";
/**
...
export interface IMessageEncryption {
     ...
     */
    decryptAttachmentContent(encryptedContent: string, metadata: EncryptedAttachmentMetadata): Promise<string>;
    /**
