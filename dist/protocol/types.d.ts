 ...
 */
export declare const MPRC_COMMAND_NAMES: readonly [
  "VERIFY",
  "FIND_USER",
  "SEND_MESSAGE",
  "LIST_MESSAGES",
 ...
 */
export declare function isVerifyCommand(
  data: unknown,
): data is VerifyProtocolCommand;
/**
 ...
 */
export declare function isFindUserCommand(
  data: unknown,
): data is FindUserCommand;
/**
 ...
 */
export declare function isSendMessageCommand(
  data: unknown,
 ...
 *
 */
export declare function isListMessagesCommand(
  data: unknown,
 ...
 */
export declare function isLoadAttachmentCommand(
  data: unknown,
 ...
 */
export declare function isReadMessageCommand(
  data: unknown,
 ...
 */
export declare function isAttachmentMetadata(
  data: unknown,
 ...
 */
export declare function createSendMessageCommand(
  message: Message,
): SendMessageCommand;
/**
 ...
 */
export declare function createReadMessageCommand(
  messageId: string,
  markAsRead?: boolean,
): ReadMessageCommand;
/**
 ...
 */
export declare function createListMessagesCommand(
  email: string,
  options?: {
    folder?: string;
    tags?: string[];
 ...
 */
export declare function createLoadAttachmentCommand(
  attachmentMetadata: AttachmentMetadata,
): LoadAttachmentCommand;
